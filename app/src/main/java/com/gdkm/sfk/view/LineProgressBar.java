...
//     * @param attrs
    ...
    private void obtainStyledAttributes(AttributeSet attrs)
    {
        ...
        final TypedArray attributes = getContext().obtainStyledAttributes(
                attrs, R.styleable.eg_LineProgressBarDialog);

        mTextColor = attributes
                .getColor(
                        R.styleable.eg_LineProgressBarDialog_progress_text_color,
                        DEFAULT_TEXT_COLOR);
        mTextSize = (int) attributes.getDimension(
                R.styleable.eg_LineProgressBarDialog_progress_text_size,
                mTextSize);

        mReachedBarColor = attributes
                .getColor(
                        R.styleable.eg_LineProgressBarDialog_progress_reached_color,
                        mTextColor);
        mUnReachedBarColor = attributes
                .getColor(
                        R.styleable.eg_LineProgressBarDialog_progress_unreached_color,
                        DEFAULT_COLOR_UNREACHED_COLOR);
        mReachedProgressBarHeight = (int) attributes
                .getDimension(
                        R.styleable.eg_LineProgressBarDialog_progress_reached_bar_height,
                        mReachedProgressBarHeight);
        mUnReachedProgressBarHeight = (int) attributes
                .getDimension(
                        R.styleable.eg_LineProgressBarDialog_progress_unreached_bar_height,
                        mUnReachedProgressBarHeight);
        mTextOffset = (int) attributes
                .getDimension(
                        R.styleable.eg_LineProgressBarDialog_progress_text_offset,
                        mTextOffset);

        int textVisible = attributes
                .getInt(R.styleable.eg_LineProgressBarDialog_progress_text_visibility,
                        VISIBLE);
...
*/
    ...
    public void setmReachedProgressBarHeight(int mReachedProgressBarHeight) {
        this.mReachedProgressBarHeight = dp2px(mReachedProgressBarHeight);
    }
    ...
    public void setmUnReachedProgressBarHeight(int mUnReachedProgressBarHeight) {
        this.mUnReachedProgressBarHeight = dp2px(mUnReachedProgressBarHeight);
    }
