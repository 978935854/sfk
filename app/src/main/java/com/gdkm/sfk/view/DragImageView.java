...
public class DragImageView extends ImageView {
	...
	private long start_time , end_time;//按下时间和放开时间

	private boolean alone = true;//用来判断单点还是多点

	private float beforeLenght, afterLenght;// 两触点距离

	private float scale_temp;// 缩放比例

	public OnTouchAction onTouchAction;
	/**
	...
	private void onTouchUp(MotionEvent event) {
		...
		if(end_time-start_time<500 && alone){
			onTouchAction.onTouchDownAndUp(true);
		}
	}
	...
	public OnTouchAction getOnTouchAction() {
